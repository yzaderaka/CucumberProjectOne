...
public class APIPayloadConstants {
    ...
    public static String CreateEmployeePayloadJson(){
        ...
        obj.put("emp_firstname","Yaroslav");
        obj.put("emp_lastname","Zaderaka");
        obj.put("emp_middle_name","Borisovich");
        obj.put("emp_gender","M");
        obj.put("emp_birthday","1984-12-23");
