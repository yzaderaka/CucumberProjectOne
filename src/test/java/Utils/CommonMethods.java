...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        initializePageObjects(); // this will initializw all the pages we have in our page
                                // PageInitializer class along with the launching of applications

        DOMConfigurator.configure("log4j.xml"); // to configure the file and pattern it has
    ...
    public static byte[] takeScreenshot(String imageName) {
        ...
        // Captures the screenshot and stores it as a file in the sourceFile variable
